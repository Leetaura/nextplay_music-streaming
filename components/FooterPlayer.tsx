...
export default function FooterPlayer() {
  ...
  return (
    <>
      ...
      <div className={cn(
        "fixed bottom-0 left-0 right-0 z-50 backdrop-blur-xl border-t transition-colors",
        isDarkMode 
          ...
          <div className="grid grid-cols-3 gap-4 items-center">
            ...
            <div className="flex flex-col items-center space-y-2">
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className="p-3 rounded-full bg-linear-to-br from-purple-500 to-pink-500 text-white hover:scale-105 transition-transform"
                >
            ...
            <div className="flex items-center justify-end space-x-2">
              ...
              <button
                ...
                className={cn(
                  "p-2 rounded-full transition-colors",
                  showVisualizer && "bg-purple-500 text-white",
                  isDarkMode && !showVisualizer && "hover:bg-gray-800",
                  !isDarkMode && !showVisualizer && "hover:bg-gray-100"
                )}
              >
                <ListMusic size={20} />
              </button>
