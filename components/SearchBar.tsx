  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-2xl mx-auto">
      <div className="relative">
        ...
        />
        <SearchIcon className={cn("absolute left-4 top-1/2 -translate-y-1/2", isDarkMode ? "text-gray-400" : "text-gray-500")} size={20} />
        <button type="submit" className="absolute right-2 top-1/2 -translate-y-1/2 px-6 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full hover:scale-105 transition-transform font-medium">
          Search
        </button>
      </div>
    </form>
