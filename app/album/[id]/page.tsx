  ...
  if (loading) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className={cn(
          "h-96 rounded-3xl animate-pulse",
      ...
      <div className={cn(
        ...
        <div className="grid md:grid-cols-2 gap-8 p-8 md:p-12">
          ...
          <div className="flex flex-col justify-center space-y-6">
            ...
            <button
              onClick={playAlbum}
              className="flex items-center justify-center space-x-2 px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full hover:scale-105 transition-transform font-semibold"
            >
