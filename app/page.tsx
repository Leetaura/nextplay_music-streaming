...
export default function HomePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-12">
      {/* Hero Section */}
      <div className={cn(
        "rounded-3xl p-8 md:p-12 bg-gradient-to-br from-purple-500 via-pink-500 to-red-500 text-white shadow-2xl",
        ...
        <div className="relative z-10">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-2xl">
            Stream millions of songs, create playlists, and enjoy high-quality music previews powered by Deezer.
          </p>
        </div>
